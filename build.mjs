...
const files=['index.html','config.js','app.js','core.js','export.js','manual.js','github.js','publish-ui.js','folder-github.js','folder-ui.js','styles.css','.nojekyll','vendor/qrcode.min.js','vendor/LICENSE-qrcode-svg.txt'];
